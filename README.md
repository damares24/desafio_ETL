...
## 🔄 Fluxo ETL 1️⃣ Extração (Extract)
...
Exemplo de .env: OPENAI_API_KEY=sua_chave_aqui

### ⚠️ O arquivo .env não deve ser versionado.

### ▶️ Como Executar o Projeto 
- 1️⃣ Criar e ativar o ambiente virtual python3 -m venv venv source venv/bin/activate

- 2️⃣ Instalar as dependências pip install pandas openai python-dotenv

- 3️⃣ Executar o script python3 main.py
